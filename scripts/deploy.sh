                    ...
                    SECRETS_PAYLOAD=$(cat <<SECRETS_EOF
{
  ...
  "secrets": [
    ...
    {"secretKey": "GITEA_REPO_URL", "secretValue": "https://git-thomas-stadelmann.nona.company/${GITEA_REPO_OWNER:-$ADMIN_USERNAME}/${REPO_NAME:-nexus-${DOMAIN//./-}-gitea}.git", "tagIds": ["$GITEA_TAG"]},
